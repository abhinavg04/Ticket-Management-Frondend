...
import { exportTickets, getAllTickets } from '../api/ticket';
...
const tickets = () => {
  ...
  return (
    <div className="flex-1 scrollbar-custom p-6">
      ...
      <div className="max-w-7xl mx-auto scrollbar-custom">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
          ...
          <div className="bg-[#0d1425]/80 backdrop-blur-xl border border-emerald-500/20 rounded-xl p-4 animate-slide-in-up" style={{ animationDelay: '0.25s' }}>
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-400 text-sm mb-1" style={{ fontFamily: 'Space Mono, monospace' }}>Closed</p>
                <p className="text-3xl font-bold text-white" style={{ fontFamily: 'Orbitron, sans-serif' }}>{stats.closed}</p>
              </div>
      ...
      {
        selectedTicket && (
          <TicketView ticket={selectedTicket} onClose={() => setSelectedTicket(null)} />
        )}
